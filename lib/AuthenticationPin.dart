...
import 'package:password_manager/widgets/ButtonPin.dart';
        ...
        child: Column(
          children: [
            ...
            TextField(
              ...
              style:
                  GoogleFonts.getFont('Inter', fontSize: 25, letterSpacing: 8),
            ...
            SizedBox(height: 20.0),
            TextButton(
              child: Text('Enter Fingerprint',
                  style: GoogleFonts.getFont('Inter',
                      fontSize: 18, color: Color(0xff323A82))),
